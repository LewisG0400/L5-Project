function [chiSquaredHistory, interactionHistory, intensityHistory] = separate_history(history)
    ...
    interactions = zeros(size(history(1).exchangeInteractions, 2));
    intensities = zeros(size(history(1).totalIntensities, 2));
