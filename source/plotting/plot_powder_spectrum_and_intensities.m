function plot_powder_spectrum_and_intensities(cropped_energy_experimental, experimentalError, cropped_energy_theory, max_energy, input_energy, cutoff_energy, lattice, lower_Q, upper_Q, Q_centre, Q_range, chi_squared, interactions)
    figure
%     subplot(2, 1, 1)
%     hold on
...
%     subplot(2, 1, 2)
    ...
    try
        pow_spec = lattice.powspec(lower_Q:0.01:upper_Q, 'Evect', cutoff_energy:0.01:max_energy, 'nRand', 1e3, 'formfact', true, 'hermit', true, 'imagChk', false, 'fid', 0, 'tid', 0);
